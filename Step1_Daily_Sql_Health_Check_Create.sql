/*
AUTHOR: SQL DBA jazeh
SUBJ: DAILY SQL SERVER HEALTH CHECK STEP 1
THE SCRIPT WILL CREATE 8 TABLES
...
-----CHANGE THE USE STATEMENT TO THE DATABASE YOU WOULD LIKE TO CREATE THE SQL DAILY HEALTH CHECK TABLES
use dba
